				...
				<ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('approveadmin') }}">Pengaduan</a></li>
                            <li><a href="{{ route('history') }}">History Pengaduan</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('akun.index') }}">Akun Utama</a></li>
                            <li><a href="{{ route('akunmasyarakat') }}">Akun Masyarakat</a></li>
                        </ul>
                    </li>
                </ul>
			</div>
